...
static int proc_target_process_open(struct inode *inode,
		struct file *file)
{
...
static int proc_normalize_real_time_open(struct inode *inode,
		struct file *file)
{
...
static ssize_t proc_monitor_status_read(struct file *file,
