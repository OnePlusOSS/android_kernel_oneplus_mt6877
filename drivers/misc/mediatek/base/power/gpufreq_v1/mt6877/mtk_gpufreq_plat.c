...
static void __mt_gpufreq_gpu_hard_reset(void)
{
	/*
	 * // [2] = mfg_rst, reset mfg
	 * Write register WDT_SWSYSRST (@ 0x1000_7200) = 0x88000004;
	 * Wait 10us;
	 * // [2] = mfg_rst, release reset
	 * Write register WDT_SWSYSRST (@ 0x1000_7200) = 0x88000000;
	 * Wait 10us;
	 */
	writel(0x88000004, g_toprgu + 0x200);
	udelay(10);
	writel(0x88000000, g_toprgu + 0x200);
	udelay(10);
}
