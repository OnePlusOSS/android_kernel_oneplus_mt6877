...
int mtk_iommu_larb_distance[] = {
	0, 5, 12, -1, 17, //0~4
	-1, -1, 29, -1, 42, //5~9
	-1, 81, -1, 110, 125, //10~14
	-1, 135, 152, 169, 186,//15~19
	190, 196, 211, 212 //20~23
};
...
struct mtk_iommu_port iommu_port[] = {
	...
	MTK_IOMMU_PORT_INIT("L1_OVL_2L_RDMA1_HDR", 0,
		SLAVE_L1, 1, TF_LARB_L1, 5),
	MTK_IOMMU_PORT_INIT("L1_OVL_2L_RDMA1", 0,
	...
	MTK_IOMMU_PORT_INIT("L13_CAM_PADI0", 0,
		SLAVE_L13, 13, TF_LARB_L13, 12),
	MTK_IOMMU_PORT_INIT("L13_CAM_PADI1", 0,
		SLAVE_L13, 13, TF_LARB_L13, 13),
	MTK_IOMMU_PORT_INIT("L13_CAM_PADO", 0,
		SLAVE_L13, 13, TF_LARB_L13, 14),
	/*Larb14 -- 10(115) */
	...
	MTK_IOMMU_PORT_INIT("L14_CAMSV7", 0,
		SLAVE_L14, 14, TF_LARB_L14, 6),
	MTK_IOMMU_PORT_INIT("L14_CAMSV8", 0,
		SLAVE_L14, 14, TF_LARB_L14, 7),
	MTK_IOMMU_PORT_INIT("L14_CAMSV9", 0,
		SLAVE_L14, 14, TF_LARB_L14, 8),
	MTK_IOMMU_PORT_INIT("L14_CAMSV10", 0,
		SLAVE_L14, 14, TF_LARB_L14, 9),
