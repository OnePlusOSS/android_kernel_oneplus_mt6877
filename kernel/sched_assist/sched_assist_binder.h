...
#endif
static inline void binder_set_inherit_ux(
	struct task_struct *thread_task, struct task_struct *from_task)
{
	...
	} else if (from_task && test_task_identify_ux(from_task,
...
static inline void binder_unset_inherit_ux(
