...
#ifndef __FOREGROUND_IO_OPT_TRACE__
#define __FOREGROUND_IO_OPT_TRACE__
...
TRACE_EVENT(block_fg_io_peek_req,
	TP_PROTO(struct task_struct *task, long req_addr, char *fg, int count),
...
#endif /* __FOREGROUND_IO_OPT_TRACE__ */
